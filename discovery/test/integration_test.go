...
import (
	...
	bccsp "github.com/tradeline-tech/fabric/bccsp/utils"
	...
	policiesmocks "github.com/tradeline-tech/fabric/common/mocks/policies"
	...
	lifecyclemocks "github.com/tradeline-tech/fabric/core/cclifecycle/mocks"
	...
	disc "github.com/tradeline-tech/fabric/discovery/client"
	...
	msprotos "github.com/tradeline-tech/fabric/protos/msp"
...
func buildBinaries() error {
	var err error
	cryptogen, err = gexec.Build("github.com/tradeline-tech/fabric/common/tools/cryptogen")
	if err != nil {
		return errors.WithStack(err)
	}

	idemixgen, err = gexec.Build("github.com/tradeline-tech/fabric/common/tools/idemixgen")
	if err != nil {
		return errors.WithStack(err)
	}
	return nil
